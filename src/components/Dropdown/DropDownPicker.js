...
class DropDownPicker extends React.Component {
    ...
    onPressClear = () => {
        this.setState({ searchableText: null })
    }
                ...
                ]}>
                    {
                        this.props.searchable && (
                            <View style={{ width: '100%', flexDirection: 'row' }}>
                                ...
                                />
                                {!!this.state.searchableText && <TouchableOpacity onPress={this.onPressClear}>
                                    <View style={styles.clearStyle}>
                                        <Feather name={'x'} color={this.props.searchablePlaceholderTextColor} />
                                    </View>
                                </TouchableOpacity>}
